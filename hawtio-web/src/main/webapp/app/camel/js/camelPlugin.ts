...
module Camel {
  ...
  export var _module = angular.module(pluginName, ['ngRoute', 'ui.bootstrap', 'ui.bootstrap', 'ui.bootstrap.modal', 'ui.bootstrap.tabs', 'ui.bootstrap.typeahead', 'ngResource', 'hawtioCore', 'hawtio-ui']);
