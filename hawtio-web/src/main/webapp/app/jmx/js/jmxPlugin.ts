...
module Jmx {
  ...
  export var _module = angular.module(pluginName, ['ngRoute', 'ui.bootstrap', 'dangle', 'ui.bootstrap', 'ui.bootstrap.modal', 'ngResource', 'datatable', 'hawtioCore', 'hawtio-ui', 'hawtioRbac']);
